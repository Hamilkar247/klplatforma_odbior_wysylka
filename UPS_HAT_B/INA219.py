...
from home.klraspi.skrypty_klraspi.wysylanie_pomiarow_do_outsystem import drukuj, nazwa_programu
import smbus
import time
import os
import sys
...
if __name__=='__main__':
    ...
    try: 
        ...
        print("Napiecie_akumulatora:{:6.3f}".format(bus_voltage))
        with open("/run/user/1000/dane_baterii.txt", "w") as f:
            f.write("Napiecie_akumulatora_w_V:{:6.3f}".format(bus_voltage))
    except Exception as e:
        drukuj(f"{e}")
        traceback.print_exc()